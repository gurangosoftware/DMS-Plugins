// <copyright file="PostInventoryUpdate.cs" company="">
// Copyright (c) 2017 All Rights Reserved
// </copyright>
// <author></author>
// <date>1/23/2017 4:51:30 PM</date>
// <summary>Implements the PostInventoryUpdate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    /// <summary>
    /// PostInventoryUpdate Plugin.
    /// Fires when the following attributes are updated:
    /// All Attributes
    /// </summary>    
    public class PostInventoryUpdate: Plugin
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryUpdate"/> class.
        /// </summary>
        public PostInventoryUpdate()
            : base(typeof(PostInventoryUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(40, "Update", "gsc_iv_inventory", new Action<LocalPluginContext>(ExecutePostInventoryUpdate)));
        ...
        protected void ExecutePostInventoryUpdate(LocalPluginContext localContext)
        {
            ...
            if (quoteDiscountEntity.LogicalName != "gsc_iv_inventory") { return; }
