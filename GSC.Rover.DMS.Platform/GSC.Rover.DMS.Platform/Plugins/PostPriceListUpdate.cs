// <copyright file="PostPriceListUpdate.cs" company="">
// Copyright (c) 2017 All Rights Reserved
// </copyright>
// <author></author>
// <date>1/6/2017 11:26:19 AM</date>
// <summary>Implements the PostPriceListUpdate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    /// <summary>
    /// PostPriceListUpdate Plugin.
    /// Fires when the following attributes are updated:
    /// All Attributes
    /// </summary>    
    public class PostPriceListUpdate: Plugin
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPriceListUpdate"/> class.
        /// </summary>
        public PostPriceListUpdate()
            : base(typeof(PostPriceListUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(40, "Update", "pricelevel", new Action<LocalPluginContext>(ExecutePostPriceListUpdate)));
        ...
        protected void ExecutePostPriceListUpdate(LocalPluginContext localContext)
        {
            ...
            if (postImageEntity.LogicalName != "pricelevel") { return; }
