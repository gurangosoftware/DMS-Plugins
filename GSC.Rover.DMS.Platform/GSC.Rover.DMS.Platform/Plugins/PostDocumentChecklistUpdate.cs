// <copyright file="PostDocumentChecklistUpdate.cs" company="">
// Copyright (c) 2016 All Rights Reserved
// </copyright>
// <author></author>
// <date>3/11/2016 1:13:56 PM</date>
// <summary>Implements the PostDocumentChecklistUpdate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    /// <summary>
    /// PostDocumentChecklistUpdate Plugin.
    /// Fires when the following attributes are updated:
    /// All Attributes
    /// </summary>    
    public class PostDocumentChecklistUpdate: Plugin
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDocumentChecklistUpdate"/> class.
        /// </summary>
        public PostDocumentChecklistUpdate()
            : base(typeof(PostDocumentChecklistUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(40, "Update", "gsc_sls_documentchecklist", new Action<LocalPluginContext>(ExecutePostDocumentChecklistUpdate)));
        ...
        protected void ExecutePostDocumentChecklistUpdate(LocalPluginContext localContext)
        {
            ...
            if (documentChecklistEntity.LogicalName != "gsc_sls_documentchecklist") { return; }
