// <copyright file="PostQuoteCabChassisUpdate.cs" company="">
// Copyright (c) 2016 All Rights Reserved
// </copyright>
// <author></author>
// <date>9/22/2016 10:10:21 AM</date>
// <summary>Implements the PostQuoteCabChassisUpdate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    /// <summary>
    /// PostQuoteCabChassisUpdate Plugin.
    /// Fires when the following attributes are updated:
    /// All Attributes
    /// </summary>    
    public class PostQuoteCabChassisUpdate: Plugin
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostQuoteCabChassisUpdate"/> class.
        /// </summary>
        public PostQuoteCabChassisUpdate()
            : base(typeof(PostQuoteCabChassisUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(40, "Update", "gsc_sls_quotecabchassis", new Action<LocalPluginContext>(ExecutePostQuoteCabChassisUpdate)));
        ...
        protected void ExecutePostQuoteCabChassisUpdate(LocalPluginContext localContext)
        {
            ...
            if (quoteCC.LogicalName != "gsc_sls_quotecabchassis") { return; }
