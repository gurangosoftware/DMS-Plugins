// <copyright file="PostOrderDiscountCreate.cs" company="">
// Copyright (c) 2016 All Rights Reserved
// </copyright>
// <author></author>
// <date>3/14/2016 3:31:50 PM</date>
// <summary>Implements the PostOrderDiscountCreate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    /// <summary>
    /// PostOrderDiscountCreate Plugin.
    /// </summary>    
    public class PostOrderDiscountCreate: Plugin
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOrderDiscountCreate"/> class.
        /// </summary>
        public PostOrderDiscountCreate()
            : base(typeof(PostOrderDiscountCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(40, "Create", "gsc_cmn_salesorderdiscount", new Action<LocalPluginContext>(ExecutePostOrderDiscountCreate)));
