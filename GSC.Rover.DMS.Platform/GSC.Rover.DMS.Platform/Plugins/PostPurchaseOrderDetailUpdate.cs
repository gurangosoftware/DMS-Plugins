// <copyright file="PostPurchaseOrderDetailUpdate.cs" company="">
// Copyright (c) 2017 All Rights Reserved
// </copyright>
// <author></author>
// <date>2/1/2017 5:59:03 PM</date>
// <summary>Implements the PostPurchaseOrderDetailUpdate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    /// <summary>
    /// PostPurchaseOrderDetailUpdate Plugin.
    /// Fires when the following attributes are updated:
    /// All Attributes
    /// </summary>    
    public class PostPurchaseOrderDetailUpdate: Plugin
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPurchaseOrderDetailUpdate"/> class.
        /// </summary>
        public PostPurchaseOrderDetailUpdate()
            : base(typeof(PostPurchaseOrderDetailUpdate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(40, "Update", "gsc_cmn_purchaseorderitemdetails", new Action<LocalPluginContext>(ExecutePostPurchaseOrderDetailUpdate)));
        ...
        protected void ExecutePostPurchaseOrderDetailUpdate(LocalPluginContext localContext)
        {
            ...
            if (vpoDetails.LogicalName != "gsc_cmn_purchaseorderitemdetails") { return; }
