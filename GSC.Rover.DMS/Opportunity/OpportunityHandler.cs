        ...
        public Entity ReplicateInquiryInfo(Entity opportunityEntity)
        {
            ...
            if (opportunityEntity.Contains("originatingleadid"))
            {
                ...
                EntityCollection prospectInquiryRecords = CommonHandler.RetrieveRecordsByOneValue("lead", "leadid", prospectInquiryId, _organizationService, null, OrderType.Ascending,
                    ...
                    "parentaccountid", "parentcontactid", "gsc_dealerid", "gsc_branchid", "gsc_portaluserid", "gsc_paymentmode", "gsc_financingtermid", "gsc_inquiryno", "gsc_productid","gsc_color" });
                ...
                if (prospectInquiryRecords != null && prospectInquiryRecords.Entities.Count > 0)
                {
                    ...
                    opportunityEntity["gsc_vehiclebasemodelid"] = prospectInquiry.Contains("gsc_vehiclebasemodelid")
                        ...
                        : null;
                    opportunityEntity["gsc_productid"] = prospectInquiry.Contains("gsc_productid")
                        ? new EntityReference(prospectInquiry.GetAttributeValue<EntityReference>("gsc_productid").LogicalName, prospectInquiry.GetAttributeValue<EntityReference>("gsc_productid").Id)
                        : null;
                    opportunityEntity["gsc_vehiclecolor"] = prospectInquiry.Contains("gsc_color")
                        ? new EntityReference(prospectInquiry.GetAttributeValue<EntityReference>("gsc_color").LogicalName, prospectInquiry.GetAttributeValue<EntityReference>("gsc_color").Id)
                        : null;
